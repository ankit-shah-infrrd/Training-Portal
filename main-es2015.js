...
let EventAddComponent = class EventAddComponent {
    ...
    validateForErrorDate(selectedDateAndTime) {
...
EventAddComponent.ctorParameters = () => [
...
let EventCardsHolderComponent = class EventCardsHolderComponent {
    constructor(cardsService) {
        this.cardsService = cardsService;
    ...
    cardObjInitialisation(card, cardIndex, dept) {
...
EventCardsHolderComponent.ctorParameters = () => [
    { type: _services_cards_service_service__WEBPACK_IMPORTED_MODULE_2__["CardsService"] }
];
...
let EventListHeaderComponent = class EventListHeaderComponent {
    constructor(appLabels, cardsService) {
...
EventListHeaderComponent.ctorParameters = () => [
...
let AppLabelsService = class AppLabelsService {
    constructor() {
